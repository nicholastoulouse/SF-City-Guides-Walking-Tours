...
-- var tours = {
INSERT INTO tours (walktitle, neighborhood, cityName, stateID, meeting_spot, latitude, longitude, meeting_details, mediawikiURL, themes)
...
--     scheduled: []
--   },
INSERT INTO tours (walktitle, neighborhood, cityName, stateID, meeting_spot, latitude, longitude, mediawikiURL, themes)
...
INSERT INTO tours (walktitle, neighborhood, cityName, stateID, meeting_spot, latitude, longitude, meeting_details, mediawikiURL, themes)
VALUES ("Bungalows of Westwood Park", "Westwood Park", "San Francisco", "CA", "OCEAN & FAXON AVES.", 37.724680, -122.459970, meeting_details, "https://en.wikipedia.org/wiki/Westwood_Park,_San_Francisco", "Craftsman, English Tudor, Spanish Revival, Colonial Revival. Visit this west side neighborhood of 650 cozy bungalows built for middleclass San Franciscans in the early 20th century.");
--   3: {
...
--   },
INSERT INTO tours (walktitle, neighborhood, cityName, stateID, meeting_spot, latitude, longitude, meeting_details, mediawikiURL, themes)
VALUES (walktitle, neighborhood, "San Francisco", "CA", meeting_spot, latitude, longitude, meeting_details, mediawikiURL, themes);
--   4: {
